...
class Simulator:
    ...
    def __init__(self, model, dims=[1, 2, 3], loss_types=['EMPIRICAL_TRAIN', 'THEORETICAL', 'EMPIRICAL_TEST'],
        ...
        :param precision (int): stop criteria. The simulation finishes when 'difference between E[predict_loss] calculated on two consecutive steps' < precision
        :param augmentation_until_n (int): increase number of generated datasets for n < augmentation_until_n
        """
